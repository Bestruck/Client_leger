...
<div class="container-fluid blog py-5">
    <div class="container py-5">
        ...
        <h4 class="text-primary">Nos Équipements</h4>
                    <h1 class="display-5 mb-4">Équipez-vous, aventurez-vous en montagne !</h1>
                    <p class="mb-0">Prêt pour l'aventure ? Louez vos équipements de sport d'hiver et de randonnée et partez à la conquête des sommets ! 
                        Que vous soyez passionné de ski, de snowboard ou de randonnée en montagne, 
                        nous avons tout ce qu'il vous faut pour vivre des moments inoubliables en toute sécurité.
                    </p>
                </div>
        </div>
        <div class="position-relative">
    ...
    <?php foreach ($equipements as $equipement): ?>
        <div class="blog-item p-4">
            <!-- <div class="blog-img mb-4">
                <img src="<?= !empty($equipement['image']) ? htmlspecialchars($equipement['image']) : 'assets/images/default-equipment.jpg' ?>" 
                     class="img-fluid w-100 rounded" 
                     alt="Équipement">
            </div> -->
            <a href="description_equipement.php?id=<?= $equipement['IDequipement'] ?>" 
               class="h4 d-inline-block mb-3"><?= htmlspecialchars($equipement['Type_d_equipement']) ?> - <?= htmlspecialchars($equipement['Detail_equipement']) ?></a>

            <div class="d-flex align-items-center">
                <div class="d-flex justify-content-center justify-content-md-end flex-shrink-0 mb-4">
                    <a class="btn btn-primary rounded-pill py-2 px-4 px-md-3 ms-2" 
                       href="description_equipement.php?id=<?= $equipement['IDequipement'] ?>">Découvrir ici</a>
                </div>
            </div>
        </div>
    <?php endforeach; ?>
