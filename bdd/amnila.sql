...
--
-- Hôte : 127.0.0.1
-- Généré le : mer. 26 mars 2025 à 17:19
...
INSERT INTO `reserver` (`IDequipement`, `IDreservation`) VALUES
(3, 5);
...
--
ALTER TABLE `equipement`
  MODIFY `IDequipement` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
